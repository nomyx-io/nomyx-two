    ...
    <div className="custom-container relative z-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="max-w-xl">
          ...
          >
            Access our comprehensive API references, SDKs, and smart contract architecture guides. Everything your engineering team needs to integrate.
          </motion.p>
            ...
            <div className="p-8 md:p-10 text-[14px] md:text-base leading-relaxed text-slate-300">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 pt-4">
                  ...
                  <span className="font-bold text-emerald-500 uppercase tracking-widest text-xs">Ready to build</span>
                </div>
              </div>
            </div>
          </div>
