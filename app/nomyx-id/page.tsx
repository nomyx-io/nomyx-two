...
/* ── Final CTA & Dashboard Mockup ── */
const IdCTA = () => (
  <section className="pt-24 pb-32 bg-bg relative overflow-hidden">
    <div className="custom-container">
      <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
        <motion.h2 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-3xl md:text-5xl font-black tracking-tight text-ink mb-8 leading-[1.1]"
        >
          Secure your assets with identity-first infrastructure.
        </motion.h2>
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Dashboard UI Mockup built with Tailwind */}
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ delay: 0.2, duration: 0.6 }}
        className="max-w-5xl mx-auto bg-white rounded-2xl border border-border shadow-[0_24px_80px_rgba(10,17,40,0.08)] flex overflow-hidden min-h-[400px] select-none"
      >
        {/* Sidebar */}
        <div className="w-[240px] bg-[#0A1128] shrink-0 p-6 flex-col hidden md:flex">
          <div className="font-black text-white text-lg tracking-tight mb-10">NomyxID</div>
          
          <div className="space-y-1 mb-8">
            <div className="px-4 py-3 bg-accent text-white rounded-xl text-sm font-bold flex items-center gap-3">
          ...
          <div className="space-y-1">
            <div className="px-4 py-3 text-slate-400 hover:text-white transition-colors rounded-xl text-sm font-medium flex items-center gap-3 cursor-pointer">
              <FileCode size={18} />
              Compliance Rules
            </div>
            <div className="px-4 py-3 text-slate-400 hover:text-white transition-colors rounded-xl text-sm font-medium flex items-center gap-3 cursor-pointer">
        ...
        {/* Main Content */}
        <div className="flex-1 bg-slate-50/50 p-6 md:p-10 flex flex-col">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
            <div>
              <h3 className="text-xl md:text-2xl font-black text-ink mb-1 tracking-tight">Welcome to NomyxID</h3>
              <p className="text-xs text-ink-muted font-medium">Decentralized Identity Management Dashboard</p>
            </div>
            <button className="h-10 px-5 rounded-lg border-2 border-accent text-accent font-bold text-xs hover:bg-accent/5 transition-colors">
              Transfer Ownership
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-8">
            <div className="bg-white border border-border rounded-xl p-5 shadow-[0_2px_10px_rgba(10,17,40,0.02)]">
              <div className="text-[11px] font-bold text-ink-muted mb-4 flex items-center justify-between">
                Registered Users
                <UserPlus size={16} className="text-slate-300" />
              </div>
              <div className="text-3xl font-black text-ink">17</div>
            </div>
            <div className="bg-white border border-border rounded-xl p-5 shadow-[0_2px_10px_rgba(10,17,40,0.02)]">
              <div className="text-[11px] font-bold text-ink-muted mb-4 flex items-center justify-between">
                Trusted Issuers
              ...
              <div className="text-3xl font-black text-ink">2</div>
            </div>
            <div className="bg-white border border-border rounded-xl p-5 shadow-[0_2px_10px_rgba(10,17,40,0.02)]">
              <div className="text-[11px] font-bold text-ink-muted mb-4 flex items-center justify-between">
                Compliance Topics
              ...
              <div className="text-3xl font-black text-ink">10</div>
            </div>
          </div>

          {/* Alert Box */}
          <div className="bg-white border border-border rounded-xl p-6 shadow-[0_2px_10px_rgba(10,17,40,0.02)]">
            <p className="text-[13px] text-ink-muted leading-relaxed font-medium max-w-2xl">
              To create a compliance rule, navigate to the <span className="font-bold text-ink">"Compliance Rules"</span> section in the Nomyx dashboard. Here, you can define a new rule by providing a unique identifier and a descriptive name.
            </p>
          </div>
        </div>
      </motion.div>
